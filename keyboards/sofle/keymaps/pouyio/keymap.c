...
[_LOWER] = LAYOUT( \
  ...
  _______,  _______, _______,  _______, _______, _______,                       _______, _______,  ALGR(ES_GRV),  ALGR(ES_PLUS),  KC_RBRC,  LALT(KC_BSPC), \
  ...
  _______,   KC_EQL, _______,  KC_PLUS, KC_LCBR, KC_RCBR, _______,       _______, ES_GRV, _______, S(KC_COMM), S(KC_DOT), S(ES_MINS), _______, \
                       _______, _______, _______, _______, _______,       _______, _______, LALT(KC_DELETE), KC_GRV, _______\
),
/* RAISE
 * ,----------------------------------------.                     ,-----------------------------------------.
 * |      |  |   |  @   |  #   |   $  |   %  |                    |   &  |   /  |  (   |   )  |   =  |  ?   |
...
[_RAISE] = LAYOUT( \
  ...
  _______,_______, _______, _______, _______, _______,  _______,       _______,  _______, KC_LSTRT, _______, KC_LEND,  _______, _______, \
